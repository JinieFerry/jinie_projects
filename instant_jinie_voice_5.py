...
entry_1 = Text(
    bd=0,
    bg="#E5D9CD",  # Background color that matches the desert theme
    fg="#A0522D",  # Foreground color that matches the desert theme
    highlightthickness=0,
    font=("RobotoRoman", 20, "bold")  # Set font size to 20 and make it bold
)
entry_1.place(
    x=171.0,
    y=193.0,
...
window.resizable(False, False)
window.mainloop()
>>>>>>> 58382d606050bafbdae4e6390b1c0828903786bf
